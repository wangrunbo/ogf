...
class SkillEffect(db.Model):
    ...
    lv6 = db.Column(db.String(100), nullable=True)
    lv7 = db.Column(db.String(100), nullable=True)
    lv8 = db.Column(db.String(100), nullable=True)
    lv9 = db.Column(db.String(100), nullable=True)
    lv10 = db.Column(db.String(100), nullable=True)
